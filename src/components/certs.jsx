...
const certs = [
  ...
  { name: "Node.js", icon: nodeIcon, certLink: nodeCert, color: "green" },
  ...
  { name: "Java", icon: JavaIcon, certLink: introCert, color: "red" },
  { name: "Spring Boot", icon: SpringbootIcon, certLink: introCert, color: "purple" },
];
